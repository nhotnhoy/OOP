 ...
 * @author Admin
 */
public class ListN extends javax.swing.JFrame {

    int id;
    String ngaynhap, nguoinhap;

    public ListN(int id, String ngaynhap, String nguoinhap) {
        this.id = id;
    ...
    private void initComponents() {
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID sản phẩm", "Tên sản phẩm", "Số lượng", "Giá", "NCC", "Thành tiền"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
